...
namespace LegalizeNuclearBombs.MonoBehaviours;
...
public class ValuableWarhead : MonoBehaviour
{
    ...
    private void LogInitValues() => LegalizeNuclearBombs.Debug(
        "Initialized values:" +
        ...
        this, LegalizeNuclearBombs.LogLevel.Verbose
    );
    ...
    private void EmissionLogic()
    {
        ...
        LegalizeNuclearBombs.Debug($"emissionColor: {material.GetColor(emissionColor).r}",
            level: LegalizeNuclearBombs.LogLevel.Verbose);
    ...
    private void ExplosionDelayRPC(PhotonMessageInfo info = default)
    {
        ...
        {
            LegalizeNuclearBombs.Debug("Photosensitivity is enabled, skipping explosion delay visual effects.",
                this);
            return;
        }
